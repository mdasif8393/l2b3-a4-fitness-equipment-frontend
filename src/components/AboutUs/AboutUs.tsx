    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">
            Welcome to Gym Tools, your trusted partner in fitness and health. We
            are dedicated to providing top-quality gym equipment to help you
            achieve your fitness goals, whether you're a seasoned athlete, a
            fitness enthusiast, or just beginning your journey to a healthier
            lifestyle.
          </p>
        </div>
      ...
      <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
        <div className="w-full lg:w-5/12 flex flex-col justify-center">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">
            At Gym Tools, our mission is simple: to empower individuals to lead
            healthier, more active lives by offering the best fitness equipment
            on the market. We believe that access to reliable and effective gym
            equipment is essential for anyone looking to improve their physical
            well-being.
          </p>
        </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                  Founded in 2002, GYM Tools was born out of a passion for
                  fitness and a desire to make high-quality gym equipment
                  accessible to everyone. Our founders, Asif Zaman, have
                  combined their expertise in fitness and business to create a
